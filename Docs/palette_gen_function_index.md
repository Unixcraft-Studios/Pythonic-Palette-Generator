...
## 0) ONE-LINE ROLE SUMMARY PER FUNCTION
...
## 1) HIGH-LEVEL ROLE OF  `palett_gen.py`
...
## 2) TYPE ALIAS / MODULE CONSTANT ROLE
...
## 3) BASIC COLOR HELPERS
### 3.1) clamp(v, lo, hi) -> float
------------------------------------------------------------
...
### 3.3) `hex_to_rgb(hex_str: str) -> RGB`
------------------------------------------------------------
...
### 3.4) rel_luminance(rgb: RGB) -> float
------------------------------------------------------------
...
### 3.5) hsv(rgb: RGB) -> Tuple[float, float, float]
------------------------------------------------------------
...
### 3.9) color_distance(a: RGB, b: RGB) -> float
------------------------------------------------------------
...
### 3.10) blend(a: RGB, b: RGB, t: float) -> RGB
------------------------------------------------------------
...
### 3.11) lighten(rgb: RGB, amount: float) -> RGB
------------------------------------------------------------
...
### 3.12) darken(rgb: RGB, amount: float) -> RGB
------------------------------------------------------------
...
### 3.13) shift_value(rgb: RGB, delta: float) -> RGB
------------------------------------------------------------
...
### .14) shift_saturation(rgb: RGB, factor: float) -> RGB
------------------------------------------------------------
...
## 5) SELECTION HELPERS
### 5.1) pick_dark_candidates(colors: List[RGB]) -> List[RGB]
------------------------------------------------------------
...
### 5.2) pick_light_candidates(colors: List[RGB]) -> List[RGB]
------------------------------------------------------------
...
### 5.3) pick_accent_candidates(colors: List[RGB]) -> List[RGB]
------------------------------------------------------------
...
### 5.4) dark_surface_score(rgb: RGB, surface_style: str) -> float
------------------------------------------------------------
...
### 5.6) unique_by_hue(colors: List[RGB]) -> List[RGB]
------------------------------------------------------------
...
### 5.7) choose_primary_accent(accents: List[RGB]) -> RGB
------------------------------------------------------------
...
## 6) PALETTE SYNTHESIS STAGE
============================================================


### 6.1) synthesize_dark_ramp(
###         darks: List[RGB],
###         accent: RGB,
###         surface_style: str
###      ) -> List[RGB]
...
## 7) PRIMARY PUBLIC PIPELINE ENTRYPOINT
### 7.1) generate_base16_palette(
        img_path,
        quantize_colors=32,
        resize_to=192,
...
## 8) OUTPUT SERIALIZERS (MODULE-FRIENDLY)
...
### 8.2) css_palette_text(palette: Dict[str, RGB]) -> str
------------------------------------------------------------
...
### 8.3) gtk2_text(palette: Dict[str, RGB]) -> str
------------------------------------------------------------
...
## 10) DEBUG / FILE HELPERS


### 9.1) print_debug_table(palette: Dict[str, RGB]) -> None
------------------------------------------------------------
...
## 9.2) write_text_file(path, text) -> None
------------------------------------------------------------
...
### 10.1) parse_args() -> argparse.Namespace
------------------------------------------------------------
